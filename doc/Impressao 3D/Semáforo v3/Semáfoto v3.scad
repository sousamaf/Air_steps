...
//	color("blue") translate([-0.5,3,0.5]) cube([2,12,8]);
...
module base()
{
	...
	{
		base1();
		color("red") translate([-27,-17.5,-13.5]) cube([56,53,4.5]);
	}
}
...
/*	difference()
	{
		...
		union()
		{
			translate([-15,9,-9]) cylinder(8.5,1,1,$fn=40);
			translate([15,18,-9]) cylinder(8.5,1,1,$fn=40);
			translate([15,0,-9]) cylinder(8.5,1,1,$fn=40);
		}
	}*/
	difference()
	{
/*		union()
		...
		union()
		{
			difference()
			{
				union()
				{
					translate([-22,9,-12.5]) cylinder(13,1,1,$fn=40);
					translate([25,28.5,-12.5]) cylinder(13,1,1,$fn=40);
					translate([25,-10.5,-12.5]) cylinder(13,1,1,$fn=40);
				}
				baseFundo();
			}
			baseFundo();
		...
		difference()
		{
			union()
			{
				translate([-24,9,-11.5]) cylinder(11.5,3.1,3.1,$fn=40);
				translate([26,31.0,-11.5]) cylinder(11.5,3.1,3.1,$fn=40);
				translate([26,-13.5,-11.5]) cylinder(11.5,3.1,3.1,$fn=40);
			}
			union()
			{
				translate([-24,9,-18]) cylinder(15,1,1,$fn=40);
				translate([26,31.0,-18]) cylinder(15,1,1,$fn=40);
				translate([26,-13.5,-18]) cylinder(15,1,1,$fn=40);
	
				translate([-24,9,-13.5]) rotate([0,0,90]) scale([1.0,1.0,0.5]) sphere(2.5,$fn=50);
				translate([26,32.5,-13.5]) rotate([0,0,90]) scale([1.0,1.0,0.5]) sphere(2.5,$fn=50);
				translate([26,-14.25,-13.5]) rotate([0,0,90]) scale([1.0,1.0,0.5]) sphere(2.5,$fn=50);
//				baseFundo();
...
module baseFundo()
{
	difference()
	{
		...
		union()
		{
//			translate([-22,-13.5,-14]) cube([44,4,8]);
			translate([-22,-13,-14]) cube([22,4,8]);
			translate([-22,28,-14]) cube([35,4,8]);

/*			translate([-22,9,-18]) cylinder(15,1,1,$fn=40);
			translate([25,28.5,-18]) cylinder(15,1,1,$fn=40);
			translate([25,-10.5,-18]) cylinder(15,1,1,$fn=40);
			...
			translate([-24,9,-13.5]) rotate([0,0,90]) scale([1.0,1.0,0.5]) sphere(2.5,$fn=50);
			translate([26,31,-13.5]) rotate([0,0,90]) scale([1.0,1.0,0.5]) sphere(2.5,$fn=50);
			translate([26,-13.5,-13.5]) rotate([0,0,90]) scale([1.0,1.0,0.5]) sphere(2.5,$fn=50);
		}
	}
}
